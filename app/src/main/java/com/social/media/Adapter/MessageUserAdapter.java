...
import com.social.media.ChatActivity;
...
public class MessageUserAdapter extends RecyclerView.Adapter<MessageUserAdapter.ViewHolder> {
    ...
    public MessageUserAdapter(Context mContext, List<User> mUsers, boolean ischat){
        this.mUsers = mUsers;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.users_message_item, parent, false);
